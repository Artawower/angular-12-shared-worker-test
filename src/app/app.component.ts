...
//
// import SharedWorker from './dal-shared.worker.ts';
...
// import workerUrl from 'worker-loader!./dal-shared.worker.ts';
...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // console.log('[line 31][app.component.ts<2>] 🚀 SW: ', SW);
    // const worker = new SW();
    //
    //
    ...
    const worker = new SharedWorker(
      // './dal-shared.worker1.js',
      new URL('./dal-shared.worker.ts', import.meta.url),
      {
        type: 'module',
      } as any
    );
